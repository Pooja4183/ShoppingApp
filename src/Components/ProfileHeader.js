...
function ProfileHeader() {
  ...
  return (
    <div className="relative group">
      {/* Profile Icon */}
      <div
        className="flex flex-col items-center text-xs font-medium text-black group-hover:text-pink-600 cursor-pointer"
      ...
      <div className="absolute top-full left-1/2 -translate-x-1/2 mt-3 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-200 bg-white rounded-lg shadow-lg w-56 p-4 z-50">
        <ul className="text-sm font-normal text-gray-600 space-y-2">
          ...
          {isAuthenticated && (
            <>
              <li
                className="hover:bg-gray-100 px-2 py-1 rounded cursor-pointer font-medium text-black"
          ...
          <li
            ...
            onClick={() => handleProtectedNavigation("/profile?tab=orders")}
          >
            Orders
          </li>
